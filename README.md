...
Configlens is a defensive cybersecurity and system-administration project written in Lua 5.4. It focuses on read-only analysis, validation, clear output, and safe handling of user-provided files, URLs, hosts, or text.
